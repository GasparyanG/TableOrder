 ...
 */
final class Version20190331095811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, restaurant_id INT NOT NULL, comment VARCHAR(255) NOT NULL, comment_time INT NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526CB1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
